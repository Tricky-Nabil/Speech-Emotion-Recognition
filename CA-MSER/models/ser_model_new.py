...
# from models.ser_vit import SER_ViT
# from models.ser_vit_new import SER_ViT_NEW
...
class Ser_Model(nn.Module):
    def __init__(self):
        ...
        # self.alexnet_model = SER_ViT(num_classes=4, in_ch=3, pretrained=True)
        # self.alexnet_model = SER_ViT_NEW(num_classes=4, in_ch=3, img_size=224, pretrained=True)
        
        self.post_spec_dropout = nn.Dropout(p=0.1)
        # self.post_spec_layer = nn.Linear(151296, 128)
    ...
    def forward(self, audio_spec, audio_mfcc, audio_wav):      
        ...
        # spectrogram - SER_CNN
        # print(audio_spec.shape) # [batch, 3, 256, 384]
        ...
        # print(audio_spec.shape)
        # audio_spec_pooled = F.adaptive_avg_pool2d(audio_spec, (6, 6))
        # audio_spec_ = torch.flatten(audio_spec_pooled, 1)
